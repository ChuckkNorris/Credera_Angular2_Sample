    ...
    return {
        setters:[
            function (add_candidate_component_1_1) {
                exports_1({
                    "AddCandidate": add_candidate_component_1_1["AddCandidate"]
                });
            },
            function (candidate_detail_component_1_1) {
                exports_1({
                    "CandidateDetail": candidate_detail_component_1_1["CandidateDetail"]
                });
            },
            function (candidate_list_component_1_1) {
                exports_1({
