System.register(['angular2/platform/browser', './app.component', 'angular2/router', 'angular2/http', './SERVICES/services.export'], function(exports_1) {
    var browser_1, app_component_1, router_1, http_1, services_export_1;
    return {
        setters:[
